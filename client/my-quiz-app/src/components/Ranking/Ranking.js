...
export const Ranking = () => {
    ...
    useEffect(() => {
        try {
            ...
            console.log(token)
            fetch(`https://quizzer-react-node-js-app-dz4a.vercel.app/api/users/getAll`, { //https://quizzer-react-node-js-app.vercel.app
                headers: {
    ...
    const followButtonThird = (email) => {
        ...
        const token = localStorage.getItem('accessToken')
        try {
            fetch(`https://quizzer-react-node-js-app-dz4a.vercel.app/api/users/${email}/follow`, {
                headers: {
                    'Content-type': 'application/json; charset=UTF-8',
                    'token': token
                },
    ...
    const unfollowButtonThird = (email) => {
        ...
        try {
            console.log(email)
            fetch(`https://quizzer-react-node-js-app-dz4a.vercel.app/api/users/${email}/unfollow`, { //https://quizzer-react-node-js-app-dz4a.vercel.app/
                headers: {
                    'Content-type': 'application/json; charset=UTF-8',
                    'token': token
                },
