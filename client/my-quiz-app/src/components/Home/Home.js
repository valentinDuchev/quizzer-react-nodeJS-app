...
export const Home = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            console.log(token)
            fetch(`https://quizzer-react-node-js-app-dz4a.vercel.app/api/newsFeed`, {
                headers: {
    ...
    const onHoverFunc = () => {
        ...
        fetch(`https://quizzer-react-node-js-app-dz4a.vercel.app/api/newsFeedRemove`, {
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
                'token': token,
    ...
    const markAsSeen = (id) => {
        ...
        fetch(`https://quizzer-react-node-js-app-dz4a.vercel.app/api/markAsSeen/${id}`, {
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
                'token': token,
            }
    ...
    const quizesAlreadySeen = () => {
        ...
        fetch(`https://quizzer-react-node-js-app-dz4a.vercel.app/api/getSeenQuizes`, {
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
                'token': token,
            }
